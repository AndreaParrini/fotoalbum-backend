@extends('layouts.app')
@section('content')
    <div class="jumbotron p-5 mb-4 bg-dark text-light ">
        <div class="container py-5">
            ...
            <h1 class="display-5 fw-bold">
                FotoAlbum Backend <i class="bi bi-box"></i>
            </h1>

            <p class="col-md-8 fs-4">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Eaque id repudiandae excepturi libero, modi sint
                nemo ullam odio aspernatur deleniti officia, distinctio nulla rem, laboriosam nisi qui atque odit quisquam?
            </p>
            <a href="{{ route('fotos.index') }}" class="btn btn-primary btn-lg" type="button">All fotos</a>
        </div>
    </div>
